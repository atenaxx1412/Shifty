...
export class ShiftManagementService {
  ...
  async createShift(
    ...
    const newShift: ShiftExtended = {
      ...
      updatedAt: now,
      metadata: {
        totalRequiredStaff: this.calculateTotalRequiredStaff(shiftData.slots || []),
        totalAssignedStaff: this.calculateTotalAssignedStaff(shiftData.slots || []),
        estimatedCost: await this.estimateShiftCost(shiftData.slots || [], shiftData.managerId!),
        complexity: this.determineShiftComplexity(shiftData.slots || []),
