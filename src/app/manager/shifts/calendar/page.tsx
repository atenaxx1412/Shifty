...
import { format, addDays, isSameDay, startOfDay, startOfMonth, endOfMonth, getDaysInMonth, startOfWeek, endOfWeek } from 'date-fns';
...
export default function ManagerShiftCalendarPage() {
  ...
  const [layoutMode, setLayoutMode] = useState<'grid' | 'traditional'>('grid');
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">シフトカレンダー</h1>
                <p className="text-gray-600">全体のシフト状況を管理</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 flex-wrap">
              ...
              <button
                onClick={() => setLayoutMode(layoutMode === 'grid' ? 'traditional' : 'grid')}
                className="flex items-center space-x-2 px-3 py-2 text-gray-600 hover:bg-gray-50 border border-gray-300 rounded-lg transition-colors whitespace-nowrap"
              >
          ...
          <div className="flex items-center justify-between bg-white rounded-lg shadow p-4">
            ...
            <div className="flex items-center">
              ...
              <div className="relative">
                <select
                  value={calendarView}
                  onChange={(e) => setCalendarView(e.target.value as CalendarViewType)}
