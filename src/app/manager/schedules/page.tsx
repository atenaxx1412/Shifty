        ...
        <main className="px-4 sm:px-6 lg:px-8 py-4 h-[calc(100vh-4rem)] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-600">アクティブスタッフ</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-green-600">アサイン済みスロット</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-orange-600">カバー率</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex items-center space-x-2 px-4 py-2 text-green-600 hover:bg-green-50 border border-green-300 rounded-lg transition-colors">
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="grid grid-cols-7 border-b border-blue-200">
              {['月', '火', '水', '木', '金', '土', '日'].map((day, index) => (
                <div key={day} className="p-4 text-center font-medium text-blue-900 bg-blue-50">
              ...
              {weekDates.map((date, index) => {
                ...
                return (
                  <div
                    ...
                    className={`p-2 border-r border-blue-200 ${
                      isToday ? 'bg-blue-100' : isPast ? 'bg-gray-50' : ''
                    } ${index === 6 ? 'border-r-0' : ''}`}
                  >
                    <div className="space-y-1">
                      {dayShifts.map((shift) => (
                        ...
                        >
                          <div className="font-medium truncate">{shift.title || 'シフト'}</div>
          ...
          {!loading && filteredShifts.length === 0 && !error && (
            <div className="text-center py-12 bg-white rounded-lg shadow">
              ...
              <p className="text-blue-500 text-lg">シフトが見つかりません</p>
